...
let foodHTML = foodOptions.map(restaurant => `<li>${resturant.name}</li>` )

//append can take in an array
...
//iterates through the number array and adds 5 to each one
...
//Second example using the numbers array above
...
// array.reduce(function (prevVal, currentVal) {}, startingPont )

let grades = [92, 88, 76, 88, 70, 100]

//want to get average of grades
    //first get the sum of grades
// then divide
...
//uniquespecialty is the empty array now
...
let combinedSentence = sentenceArray.reduce((previousValue, currentValue) => previousValue + currentValue, "Hey you! ");
